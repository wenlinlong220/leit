...
**Q1: Harvard and Yale were the first universities to benefit from philanthropy.**
- 定位词：Harvard, Yale, first
- 考点词：`first`（第一个）
- 原文：...oldest universities such as Bologna, Oxford and Cambridge **in the twelfth century**, to **relative newcomers** like Harvard and Yale **in the seventeenth century**
- 分析：题目说哈佛耶鲁是"第一个"受捐赠的，但原文明确说 Bologna、Oxford、Cambridge 在12世纪就已受捐——比哈佛耶鲁早几百年。`first` ↔ `relative newcomers`（后来者）→ **直接矛盾**
- 🧠 错题笔记：看到 "first/最早" 要去原文找有没有**更早的反例**。有反例 → FALSE，没提 → NOT GIVEN
- ❌ 答案：**FALSE**

---

**Q2: Merchants liked to donate to the same universities they attended themselves.**
- 定位词：Merchants, donate, attended
- 考点词：`attended themselves`（曾就读的大学）
- 原文：Wealthy merchants gave young institutions money, land, libraries and rare items.
- 分析：原文只说商人"捐赠"，**完全没有提及**他们是否捐给自己就读的学校
- ❓ 答案：**NOT GIVEN**

---

**Q3: The first gift to the University of Auckland came in 1884.**
- 定位词：first gift, 1884
- 考点词：`first gift`（第一笔捐赠）
- 原文：In 1884 Mr Justice Gillies...became its **original philanthropist**
- 分析：`first gift` ↔ `original philanthropist`（最初捐赠者 → 即第一笔捐赠发生在此时）→ 同义替换，完全吻合
- 🧠 错题笔记："first gift"和"original philanthropist"是同义替换，不是陷阱。**同义替换 → TRUE，不是 NOT GIVEN**
- ✅ 答案：**TRUE**

---

**Q4: The University of Otago often received larger gifts than Gillies' gift to Auckland.**
- 定位词：University of Otago, larger gifts
- 考点词：`larger`（更大）
- 原文：Gillies' gift was **more generous even than those regularly given** to New Zealand's older University of Otago
- 分析：原文说 Gillies 的捐赠"甚至比 Otago 经常收到的更慷慨" → 即 Otago 收到的礼物**更小**，题目说更大 → **直接矛盾**
- ❌ 答案：**FALSE**

---

**Q5: In the 1930s the government wanted to close Auckland's engineering school.**
- 定位词：1930s, government, engineering school
- 考点词：`close`（关闭）
- 原文：the engineering school in Auckland, which the **state** was determined to see **discontinued**
- 分析：`government` ↔ `state`（同义替换），`close` ↔ `discontinued`（同义替换）→ 完全吻合
- ✅ 答案：**TRUE**

---

**Q6: After raising $6,500, Crookes returned to academic life.**
- 定位词：Crookes, $6,500, returned to academic life
- 考点词：`returned to academic life`
- 原文：只说 Crookes 筹集了6500美元，**没有提及**他之后做了什么
- ❓ 答案：**NOT GIVEN**

---

**Q7: In the 1950s the best lecturers chose to work in Britain or Australia rather than Auckland.**
- 定位词：1950s, best lecturers, Britain, Australia
- 考点词：`chose to work in Britain or Australia`
- 原文：the **strongest candidates tended to be recruited** to those countries（Britain and Australia）
- 分析：`best lecturers` ↔ `strongest candidates`，`chose to work` ↔ `tended to be recruited`（同义替换）→ 完全吻合
- ✅ 答案：**TRUE**

---

**Q8: A single philanthropist was responsible for the new Medical School.**
- 定位词：Medical School, single philanthropist
- 考点词：`single`（单独一个）
- 原文：it attracted significant gifts...from an **unusually wide range of donors**, including **individuals, trusts, charitable foundations, societies and community groups**
- 分析：题目说"单一一位慈善家"负责，原文说"异常广泛的捐赠者群体"→ `single` ↔ `wide range of donors` → **直接矛盾**
- 🧠 错题笔记：individuals 是复数，且只是众多捐赠者来源之一。看到"a single person/one person did something"要去找原文是否说多人参与。
- ❌ 答案：**FALSE**
...
**Q9: Henry Cooper's campaign marked the ______ of the University**
- 原文：who raised $800,000 to celebrate the University's ==centenary==
- ✅ 答案：**centenary**

**Q10: this appeal is raising money to invest in the University's ______**
- 原文：with a focus on generating funds to recruit, support and retain the very best ==staff== for the University
- ✅ 答案：**staff**

**Q11: gifts are being sought from graduates who are located ______**
- 原文：targeting ==alumni==, or former students now living ==overseas==
- 分析：题目问的是 graduates（= alumni）在哪里 → **overseas**
- 🧠 错题笔记：原句是 both A **and** B 结构——A = local communities，B = overseas alumni。题目问的是 graduates/alumni，对应的是 B 那一组，不是 A。**一定要读完整句，确认空格对应哪个群体。**
- ✅ 答案：**overseas**

**Q12: some donations had not been ______ by the University**
- 原文：giving to the University that has not been previously ==recorded== through our Advancement Office
- ✅ 答案：**recorded**

**Q13: there is a new financial ______ for the campaign**
- 原文：the campaign ==target== was now being increased from $100 million to $150 million
- 分析：题目填 "new financial ______"，同一段还有 support，但 support 前修饰词是 philanthropic，且整句重点是 target 从1亿增加到1.5亿 → 是"新的财务目标"
- 🧠 错题笔记：同一段出现多个名词时，结合题目修饰词（financial）判断哪个词语义最匹配。"financial target（财务目标）"比"financial support"更准确。
- ✅ 答案：**target**
:::end-right
...
- 主干：This has been true **from A to B**（从A到B都是如此）
- A = some of the oldest universities...in the twelfth century（12世纪最古老的大学）
- B = relative newcomers...in the seventeenth century（17世纪的后来者）

**考点：**

- `relative newcomers`（相对的新来者）→ Q1 考点，Harvard/Yale 是"newcomer"，不是"first"
- `from...to...` 表示范围，暗示"都受到了慈善捐赠"

---

### 句二：both A and B 结构（Q11 陷阱句）

**原句：**

The University is investing considerable time and energy in devising new methods of fund-raising **both within its local communities** and—remembering that New Zealanders love to travel—**by looking at campaigns in other parts of the world, and targeting alumni, or former students now living overseas**.

**结构拆解：**

- `both A and B`：
  - **A** = within its local communities（在本地社区范围内）
  - **B** = targeting alumni...living overseas（针对海外校友）
- 破折号中间的插入语：`remembering that New Zealanders love to travel`（交代背景，解释为何要找海外校友）

**Q11 陷阱：**

题目问"graduates are located ______"，graduates = alumni，对应的是 B 组 → overseas。communities 是 A 组，与 graduates 无关。
