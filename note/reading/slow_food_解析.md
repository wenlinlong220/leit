# The Slow Food Organization 全题解析
...
**Q1: The Ark of Taste lists food plant and animal species in danger of extinction.**
- 定位词：Ark of Taste
- 考点词：`lists`、`in danger of extinction`
- 原文：The Ark of Taste is the ==catalog== of ==endangered== food plant and animal species
- 分析：`lists` ↔ `catalog`（同义替换），`in danger of extinction` ↔ `endangered`（同义替换）
- ✅ 答案：**TRUE**

---

**Q2: Slow Food considers that the term 'biodiversity' should be restricted to wild species.**
- 定位词：biodiversity, wild species
- 考点词：`restricted to`（仅限于）
- 原文：Biodiversity is a term commonly associated with discussions of threats to ==wild species==, but according to Slow Food the biodiversity of the ==domesticated species== people have depended on for centuries is ==no less important==
- 分析：题干说"biodiversity应仅限于wild species"，但原文说驯化物种的生物多样性"同样重要"（no less important）。`restricted to` ↔ `no less important` → **直接矛盾**
- ❌ 答案：**FALSE**
...
**Q4: Countries can sell the genes of their heritage plant varieties internationally.**
- 定位词：countries, sell genes, internationally
- 考点词：`sell...internationally`
- 原文：原文只讨论了heritage plant的基因对plant breeders的重要性，**没有提及**国家之间出售基因的信息
- 分析：原文没有涉及基因交易/国际售卖的话题，完全未提及
- ❓ 答案：**NOT GIVEN**

---

**Q5: Slow Food maintains that food and culture exist independently of each other.**
- 定位词：food and culture
- 考点词：`independently`（独立地）
- 原文：when a variety of food or breed of animal disappears, ==something greater also disappears==: a specific, irreplaceable mode of life...
- 分析：原文说食物消失时，一种生活方式（文���）也随之消失 → 食物和文化是**紧密相连**的。题干说"独立存在"，与原文**直接矛盾**
- ❌ 答案：**FALSE**

---

**Q6: Some Native Americans are now giving cookery classes featuring Iroquois white corn.**
- 定位词：Native Americans, cookery classes, Iroquois white corn
- 考点词：`cookery classes`（烹饪课程）
- 原文：helping to preserve the ==specific cookery and religious uses== that the corn has been selected to support
- 分析：原文提到"烹饪用途"（cookery uses），但**没有提到**"烹饪课程"（cookery classes）。`cookery uses ≠ cookery classes`，这是典型的部分提及型 NOT GIVEN
- ❓ 答案：**NOT GIVEN**
...
|---|---|---|---|
| Slow food | 7\_\_\_\_ | 8\_\_\_\_ | high |
| Fast food | 9\_\_\_\_ | enormous | low |

**Q7: Slow Food 的 Taste 是什么？**
- 原文：the taste of a recognized Slow Food is ==unique== to that food
- ✅ 答案：**unique**

**Q8: Slow Food 的 Quantities sold 是什么？**
- 原文：the quantities of Slow Food products which are available for selling are ==limited==
- ✅ 答案：**limited**

**Q9: Fast Food 的 Taste 是什么？**
- 原文：global fast food companies aim to sell food that has an ==unchanging== taste wherever in the world it is eaten
- ✅ 答案：**unchanging**
...
**Q10: What were farmers in the USA given so that they could raise endangered turkeys?**
- 原文：The project was for the farmers to raise a total of 5,000 turkeys from ==eggs== which had been selected from four varieties of endangered turkey
- 分析：farmers 被给予了 eggs 来孵化火鸡
- ✅ 答案：**eggs**

**Q11: How many varieties of endangered turkey benefited from the project?**
- 原文：eggs which had been selected from ==four== varieties of endangered turkey
- ✅ 答案：**4 / four**

**Q12: Who was not happy with the size of the turkeys?**
- 原文：Although ==chefs== in some restaurants... ==complained== that the Slow Food turkeys were ==smaller== than industrially produced turkeys
- 分析：`not happy with the size` ↔ `complained...smaller`（抱怨更小）
- ✅ 答案：**chefs**

**Q13: Who liked the taste of the endangered turkeys?**
- 原文：the distinctive flavors were very well received by ==consumers==
...
1. `commonly associated with...` → 过去分词短语，后置定语修饰 *term*
2. `according to Slow Food` → 状语，交代观点来源
3. `of the domesticated species` → 介词短语，定语修饰 *biodiversity*
4. `(that) people have depended on for centuries` → 定语从句（省略了关系词 that），修饰 *species*
   - 还原：People have depended on these species for centuries.

**核心考点：**

- **domesticated species**（驯化物种）↔ **wild species**（野生物种）→ 对比考点
- **no less important** = 同样重要（双重否定表示肯定，语气更强）→ 与题干 `restricted to wild species` 矛盾，答案为 FALSE
- **Reduced Relative Clause**：species 后省略了作宾语的关系代词 that/which
...
- `raise` → 抚育、饲养
- `begin by doing` → 首先做某事（begin 在这里译为"首先"）
- `hatch` → 孵化
- `raising the young turkeys to adults` → 把小火鸡**养大**（to adults = 到成年，不是"养给成年人"）
- `They were promised a guaranteed price per pound for the adult turkeys` → 他们被承诺，每磅成年火鸡将获得保证的价格（被动语态，They = 农民们）
...
| 词/短语 | 含义 | 备注 |
|---|---|---|
| `no less important` | 同样重要 | 双重否定=肯定，比 important 语气更强 |
| `be restricted to` | 局限于…… | 有明显的排他倾向性 |
| `vital importance` | 至关重要 | ↔ `need`（需要），同义替换考点 |
...
- `-ism` → 主义/制度/概念（environmentalism 环保主义、capitalism 资本主义）→ **不是人**
- `-ist` → 持某主义的人（environmentalist 环保人士、capitalist 资本家）→ **是人**

> 简答题问 **Who** 时，答案必须是人，`-ism` 结尾的词直接排除。
